...
func main() {
	...
	world.Add(NewSphere(Point3{190, 90, 190}, 90, glass))

	// Light Sources
	lights := HittableList{}
	lights.Add(NewQuad(Point3{343, 554, 332}, Vec3{-130, 0, 0}, Vec3{0, 0, -105}, EmptyMaterial{}))
	lights.Add(NewSphere(Point3{190, 90, 190}, 90, EmptyMaterial{}))
